...
def action(args):
    ...
    proc_video(innput, None, 0, process_image, window_name=innput)
...
def parse_arguments():
    ...
    # Add parser input.
    group.add_argument("-v", "--video", default=None, help="Set the video input path")
    # Add parser output.
    group.add_argument("-i", "--image", default=None, help="Set image input path")
